...
- July is the peak demand month, while September and October show a noticeable dip
...
- Classic category is the top seller with ~15K pizzas sold
...
Sales distribution by time slot
...
Comparison of orders, revenue, and quantity sold
...
Optimized SQL Queries – Improved performance using indexing and structured queries
...
Promote Large pizzas through combo offers to maximize revenue

Boost visibility of high-revenue but mid-volume pizzas (e.g., Barbecue Chicken)

Re-evaluate low-performing pizzas for recipe improvement or targeted discounts
...
End-to-end analytics thinking (Data → Query → Dashboard → Decision)
